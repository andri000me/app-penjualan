<script>
   ...
   $(document).ready(function() {
      ...
      table = $('.tabel-detail').DataTable({
         ...
         "serverside": true,
         "ajax": {
            "url": "../lib/pembelian/pembelian_detail_data.php",
            "type": "GET"
         },
         "language": {
      ...
      $('#id_produk').keyup(function(e) {
         ...
         $.ajax({
            type: "GET",
            url: "../lib/pembelian/pembelian_produk.php?id=" + $(this).val(),
            dataType: "JSON",
            beforeSend: function() {
      ...
      $('.btn-tambah').click(function(e) {
         ...
         $.ajax({
            type: "POST",
            url: "../lib/pembelian/pembelian_tambah_keranjang.php",
            data: {
   ...
   function ubahJumlah(productID) {
      $.ajax({
         type: "POST",
         url: "../lib/pembelian/pembelian_ubah_keranjang.php",
         data: {
            id_produk: productID,
   ...
   function deleteItem(productID) {
      $.ajax({
         type: "POST",
         url: "../lib/pembelian/pembelian_hapus_keranjang.php",
         data: {
            id_produk: productID
         },
         success: function(response) {
   ...
   function loadCart(diskon = 0) {
      ...
      $.ajax({
         type: "GET",
         url: "../lib/pembelian/pembelian_load.php?diskon=" + diskon + "&total=" + $('.total').val(),
         dataType: "JSON",
